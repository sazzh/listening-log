...
export const createArtistService = async (artistName, artistType, artistCountry, artistDisambiguation, isDisbanded) => {
...
export const deleteArtistService = async (artistId) => {
