...
import { createArtistNote, getAllArtistNotes } from '../../controllers/notes/artistNotesController.js';
...
router.get('/user/notes', protect, getAllArtistNotes); // get all notes for all artist entities by user
